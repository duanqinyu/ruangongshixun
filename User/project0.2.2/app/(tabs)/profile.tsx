...
import { Settings, ChevronRight, Award, Calendar, ChartBar as BarChart2, Clock, Zap, LogOut, X, Camera, Mail, Key, User, ClipboardList } from 'lucide-react-native';
      ...
      <ScrollView style={styles.scrollView}>
        ...
        <View style={styles.menuSection}>
          ...
          >
            ...
            <Text style={styles.menuText}>饮食计划</Text>
            <ChevronRight size={20} color="#C7C7CC" />
          </TouchableOpacity>
        </View>
